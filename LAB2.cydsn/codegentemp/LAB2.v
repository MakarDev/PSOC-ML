...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("0a70244a-e1ad-441d-8a01-8a1c71816857/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("0a70244a-e1ad-441d-8a01-8a1c71816857/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
localparam [1:0] Add_finish = 2'b10;
...
assign Datapath_1_select[0] = (MAC==Idle);
assign Datapath_1_select[1] = (MAC==Add_finish);
assign Datapath_1_select[2] = (1'b0);

/* ==================== Datapath_1 (Width: 8) Instantiation ==================== */
parameter Datapath_1_dpconfig0 = 
{
    `CS_ALU_OP__ADD, `CS_SRCA_A0, `CS_SRCB_D0, `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE, `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA, `CS_CMP_SEL_CFGA,  /*CFGRAM0: Multiply-and-accumulate */
    `CS_ALU_OP__XOR, `CS_SRCA_A0, `CS_SRCB_A0, `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE, `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA, `CS_CMP_SEL_CFGA,  /*CFGRAM1: Reset(sets A0 to 0) */
    `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0, `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE, `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA, `CS_CMP_SEL_CFGA,  /*CFGRAM2: Latch output after adding */
...
begin : Idle_state_logic
    case(MAC)
        ...
        begin
            dsignal <= (1'b1);
            if (( go_to_mac_0==1'b0 ) == 1'b1)
            begin
                MAC <= Idle ;
            end
            else if (( go_to_mac_1==1'b1 ) == 1'b1)
            begin
                MAC <= Add ;
            end
        end
...
/* ==================== go_to_mac ==================== */
    CyControlReg_v1_80 go_to_mac (
        .control_1(go_to_mac_1),
        .control_2(ctrl_2),
        .control_3(ctrl_3),
        .control_0(go_to_mac_0),
        .control_4(ctrl_4),
        .control_5(ctrl_5),
        .control_6(ctrl_6),
        .control_7(ctrl_7),
        .clock(clock),
        .reset(1'b0));
    defparam go_to_mac.Bit0Mode = 1;
    defparam go_to_mac.Bit1Mode = 1;
    defparam go_to_mac.Bit2Mode = 1;
    defparam go_to_mac.Bit3Mode = 1;
    defparam go_to_mac.Bit4Mode = 1;
    defparam go_to_mac.Bit5Mode = 1;
    defparam go_to_mac.Bit6Mode = 1;
    defparam go_to_mac.Bit7Mode = 1;
    defparam go_to_mac.BitValue = 0;
    defparam go_to_mac.BusDisplay = 0;
    defparam go_to_mac.ExtrReset = 1;
    defparam go_to_mac.NumOutputs = 8;

/* ==================== input_a ==================== */
    CyControlReg_v1_80 input_a (
        .control_1(ctrl_8),
        .control_2(ctrl_9),
        .control_3(ctrl_10),
        .control_0(ctrl_0),
        ...
        .clock(clock),
        .reset(1'b0));
    defparam input_a.Bit0Mode = 1;
    defparam input_a.Bit1Mode = 1;
    defparam input_a.Bit2Mode = 1;
    defparam input_a.Bit3Mode = 1;
    defparam input_a.Bit4Mode = 1;
    defparam input_a.Bit5Mode = 1;
    defparam input_a.Bit6Mode = 1;
    defparam input_a.Bit7Mode = 1;
    defparam input_a.BitValue = 0;
    defparam input_a.BusDisplay = 0;
    defparam input_a.ExtrReset = 1;
    defparam input_a.NumOutputs = 8;
...
module SPI_Master_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("a1ff9686-777d-4e26-9f19-2acbe1631cb0/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module ADC_SAR_v3_0_3 (
	...
	cy_clock_v1_0
		#(.id("37a21970-a7e6-479f-b304-d81bc7cb1fd5/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("37a21970-a7e6-479f-b304-d81bc7cb1fd5/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("3d27a69a-af78-4c56-8a4e-be022e7a1d32"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fb3ae143-b78a-457e-87a4-9cf31f2c4c9d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ffaf8a89-277e-4585-802d-b1b0ceec6bf1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6ef43622-059f-4da9-9ba3-d3f8b5a228a8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5042545b-4c75-404f-bfac-8c5e2477341b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a6742e97-e2e9-4fab-967f-2f8c3d8f2482"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pot_V_net;
	wire [0:0] tmpFB_0__Pot_V_net;
	wire [0:0] tmpIO_0__Pot_V_net;
	wire [0:0] tmpINTERRUPT_0__Pot_V_net;
	electrical [0:0] tmpSIOVREF__Pot_V_net;

	cy_psoc3_pins_v1_10
		#(.id("622f7204-1a76-49a0-b1b7-cfca6d2fb3b3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pot_V
		 (.oe(tmpOE__Pot_V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot_V_net[0:0]}),
		  .analog({Net_55}),
		  .io({tmpIO_0__Pot_V_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot_V_net),
		  .interrupt({tmpINTERRUPT_0__Pot_V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot_V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3d1e5a6e-d510-49ae-a262-72157fa87c8a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CLR_net;
	wire [0:0] tmpIO_0__CLR_net;
	wire [0:0] tmpINTERRUPT_0__CLR_net;
	electrical [0:0] tmpSIOVREF__CLR_net;
	...
	cy_psoc3_pins_v1_10
		...
		CLR
		 (.oe(tmpOE__CLR_net),
		  .y({1'b0}),
		  .fb({Net_84}),
		  .io({tmpIO_0__CLR_net[0:0]}),
		  .siovref(tmpSIOVREF__CLR_net),
		  .interrupt({tmpINTERRUPT_0__CLR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CLR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
